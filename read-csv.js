	...
	var theEl2=document.getElementById("output2");
	  ...
	  ymaps.geocode(pointB).then(function (res) {
		   ...
		   var WayCoord = ymaps.formatter.distance(
			...
			theEl.innerHTML = theEl.innerHTML+'<table border="0" style="text-align: justify; font-family: Verdana; font-size:10px;"><tr><td class="lc">'+pointB+';</td><td class="even2">'+point+';</td><td class="even">'+ret+';</td><td class="way">'+ WayCoord +'</td><td class="way">'+pointNum+'</td></tr>'; //+'; Расстояние: '+(A*0.001).toFixed() + 'км.';
